...
@Service
public class VaccineService implements Iservice {
	...
	@Transactional(readOnly =true)
	public List<VaccineAvailabilityDto> findAllVaccinesByBranchId(String branchSerialNo)
	{
		List<VaccineAvailabilityDto> vaccineAvailabilityDtoList=null;//= vaccineRepository.getVaccineAvailability(branchSerialNo);
        return vaccineAvailabilityDtoList;
	}
